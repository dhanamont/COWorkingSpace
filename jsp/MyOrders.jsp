...
<html class="no-js"> <!--<![endif]-->
    ...
    <body>
        ...
        <sql:query var="history" dataSource="${it58070122_se}">
            ...
            o.Room_Name, y.Type_Name, s.Space_Name, s.Place, o.Price
            From `User` u
                                                                ...
                                                                <div id="collapse<%= num%>" class="panel-collapse collapse">
                                                                    <div class="panel-body">
                                                                        ...
                                                                        <div class="row">
                                                                                ...
                                                                                <div class="table-responsive">
                                                                                    <table class="table table-bordered table-hover">
                                                                                        ...
                                                                                        <tbody>
                                                                                            ...
                                                                                            <tr align="center">
                                                                                                <td><c:out value="${row.Type_Space}"/></td>
                                                                            ...
                                                                            <fmt:formatNumber var="sum" type="number" minFractionDigits="2" maxFractionDigits="2" value="${Price}" />
                                                                            <div class="col-lg-12 text-right"> Order total : &nbsp;<b><c:out value="${sum}"/></b></div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
