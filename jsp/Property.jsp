                ...
                <div class="clearfix padding-top-40">
                    <div class="col-md-8 single-property-content ">
                        ...
                        <div class="single-property-wrapper">
                            ...
                            <!--Start create map-->         
                            <span class="glyphicon glyphicon-map-marker"></span><span> <%= request.getAttribute("Place")%>  </span><span class="glyphicon glyphicon-triangle-bottom" aria-hidden="true" data-toggle="collapse" data-target="#demo"></span>
