            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse yamm" id="navigation">
                    <div class="button navbar-right">
                        <button class="navbar-btn nav-button wow bounceInRight login" onclick=" window.open('RegisterMember.jsp')" data-wow-delay="0.4s">Login</button>
                        <button class="navbar-btn nav-button wow fadeInRight" onclick=" window.open('RegisterEn.jsp')" data-wow-delay="0.5s">Submit</button>
                    </div>
                                     ...
                                     <div class="tab-pane" id="step1">
                                         <form name="SignUpEnt" method="POST" action="SignUpEnt">
                                                <div class="form-group">
                                                    ...
                                                    <input name="Username" type="text" class="form-control" placeholder="Super villa ...">
                                                </div>
                                                
                                                <div class="form-group">
                                                    <label>Password<small>(required)</small></label>
                                                    <input name="Password" type="text" class="form-control" placeholder="Super villa ...">
                                                </div>
                                                
                                                 <div class="form-group">
                                                    <label>FirstName<small>(required)</small></label>
                                                    <input name="Fname" type="text" class="form-control" placeholder="Super villa ...">
                                                </div>
                                     
                                                 <div class="form-group">
                                                    <label>LastName<small>(required)</small></label>
                                                    <input name="Lname" type="text" class="form-control" placeholder="Super villa ...">
                                                </div>
                                                
                                                <div class="form-group">
                                                    <label>Email<small>(required)</small></label>
                                                    <input name="Email" type="text" class="form-control" placeholder="Super villa ...">
                                                </div>
