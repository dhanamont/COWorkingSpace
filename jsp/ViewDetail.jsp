                        ...
                        <div class="well col-xs-10 col-sm-10 col-md-6 col-xs-offset-1 col-sm-offset-1 col-md-offset-3">
                            <div class="section additional-details">
                                ...
                                <ul class="additional-details-list clearfix" style="background-color:#FFFFFF;">
                                        <li>
                                            <span class="col-xs-6 col-sm-4 col-md-4 add-d-title">Order ID</span>
                                            <span class="col-xs-6 col-sm-8 col-md-8 add-d-entry">${requestScope.Order_ID}</span>
                                        </li>

                                        <li>
                                            <span class="col-xs-6 col-sm-4 col-md-4 add-d-title">Type Name</span>
                                            <span class="col-xs-6 col-sm-8 col-md-8 add-d-entry">${requestScope.Type_Name}</span>
                                        </li>

                                        <li>
                                            <span class="col-xs-6 col-sm-4 col-md-4 add-d-title">Room Name</span>
                                            <span class="col-xs-6 col-sm-8 col-md-8 add-d-entry">${requestScope.Room_Name}</span>
                                        </li>

                                        <li>
                                            <span class="col-xs-6 col-sm-4 col-md-4 add-d-title">Table ID</span>
                                            <span class="col-xs-6 col-sm-8 col-md-8 add-d-entry">${requestScope.Table_ID}</span>
                                        </li>

                                        <li>
                                            <span class="col-xs-6 col-sm-4 col-md-4 add-d-title">Order Status</span>
                                            <span class="col-xs-6 col-sm-8 col-md-8 add-d-entry">${requestScope.Order_Status}</span>
                                        </li>

                                        <li>
                                            <span class="col-xs-6 col-sm-4 col-md-4 add-d-title">Total Price</span>
                                            <span class="col-xs-6 col-sm-8 col-md-8 add-d-entry">${requestScope.Total_price}</span>
                                        </li>

                                        <li>
                                            <span class="col-xs-6 col-sm-4 col-md-4 add-d-title">Order Date</span>
                                            <span class="col-xs-6 col-sm-8 col-md-8 add-d-entry">${requestScope.Order_Date}</span>
                                        </li>
                                ...
                                <form name="ViewDetailServlet" method="post" action="ViewDetailServlet">
                                    <input type="hidden" name="id" value="${requestScope.Order_ID}"/>
                                    <c:choose>
                            <c:when test="${requestScope.Order_Status == 'WAITING'}">
                                <div class=".col-md-3 .col-md-offset-3 text-right">
                                    <input class="btn btn-default" id="accept" type="submit" name="buttonValue" value="PAID"></button>
                                    <input class="btn btn-default" id="cancel" type="submit" name="buttonValue" value="CANCEL"></button>
                                </div>
                            </c:when>
                             <c:when test="${requestScope.Order_Status == 'PAID'}">
                                <div class=".col-md-3 .col-md-offset-3 text-right">
                                    <input class="btn btn-default" id="cancel" type="submit" name="buttonValue" value="CANCEL"></button>
                                </div>
                            </c:when>
