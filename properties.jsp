                                    ...
                                    <div class="inner-wrapper">
                                        ...
                                        <div class="clear">
                                            ...
                                            <div class="col-xs-8 col-sm-8 ">
                                                <h3 class="dealer-name">
                                                    <a href=""><%= session.getAttribute("Space_Name") %></a>
                                                    <span><%= session.getAttribute("Company_name") %></span>        
                                                </h3>
                                        ...
                                        <div class="clear">
                                            <ul class="dealer-contacts">                                       
                                                <li><i class="pe-7s-map-marker strong"> </i><%= session.getAttribute("Location") %></li>
                                                <li><i class="pe-7s-call strong"> </i><%= session.getAttribute("Phone_company") %></li>
                                            </ul>
                                ...
                                <div class="panel-body recent-property-widget">
                                        ...
                                        <li>
                                            ...
                                            <div class="col-md-8 col-sm-8 col-xs-8 blg-entry">
                                                <h6> <a href="single.html"><%= session.getAttribute("Username")%></a></h6>
